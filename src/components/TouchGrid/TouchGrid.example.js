...
const RedComponent = () => (_jsx("div", { style: {
...
const BlueComponent = () => (_jsx("div", { style: {
...
const GreenComponent = () => (_jsx("div", { style: {
...
const YellowComponent = () => (_jsx("div", { style: {
...
const PurpleComponent = () => (_jsx("div", { style: {
...
const OrangeComponent = () => (_jsx("div", { style: {
...
export const exampleTouchGridProps = {
    width: 12,
    height: 12,
    items: instances,
};
