...
import { DragEndEvent, Modifiers } from '@dnd-kit/core';
import {
...
export const useTouchGrid = ({
  ...
  const [internalItems, setInternalItems] = useState<TouchGridInstance<any>[]>(items || []);
  ...
  const handleDragEnd = (event: DragEndEvent) => {
    ...
    // Collision check
    const hasCollision = currItems.some(
